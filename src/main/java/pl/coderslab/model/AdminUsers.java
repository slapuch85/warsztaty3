        ...
        while (!answer.equals("quit")) {
            ...
            if (answer.equals("add")) {
                ...
                try (Connection conn = DBConnection.getConnection()) {
                    ...
                    scanner.nextLine();
                    pl.coderslab.UserGroup userGroup = pl.coderslab.UserGroup.loadUserGroupById(conn, groupId);
                    pl.coderslab.User user = new User(username, email, password, userGroup);
                    user.saveToDB(conn);
                } catch (SQLException e) {
                    e.printStackTrace();
                }
